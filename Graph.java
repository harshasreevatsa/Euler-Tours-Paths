...
class Graph implements Iterable<Vertex> {
     ...
     */
    void addDirectedEdge(int b, int a, int weight) {
	...
	System.out.println("please enter the edges in the order of TAIL----->HEAD in case of directed graph, and any order in case of undirected graphs, followed by the corresponding weight");
